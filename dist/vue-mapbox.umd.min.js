  ...
  return (function(t) {
    ...
    "01f9": function(t, e, n) {
      ...
      t.exports = function(t, e, n, y, g, b, _) {
        ...
        if (
          ...
          if (
            ((x = { values: E ? k : I(m), keys: b ? k : I(h), entries: j }), _)
          )
    ...
    ac6a: function(t, e, n) {
      for (
        ...
        var v,
          ...
          b = a[y],
          _ = b && b.prototype;
        if (_ && (_[f] || c(_, f, l), _[d] || c(_, d, y), (s[y] = l), g))
    ...
    fb15: function(t, e, n) {
      ...
      function p() {
        ...
        return (
          Object.entries(d).forEach(function(e) {
            t[e[0]] = function(t, n) {
              return l.call(this, e[0], e[1].bind(this), t, n);
            };
          }),
          t
        );
      ...
      var w = {
        ...
        R = A,
        z = x(R, C, B, !1, null, null, null);
      z.options.__file = "Marker.vue";
      var N = z.exports,
        Z = function() {
          var t = this,
            e = t.$createElement,
        ...
        G = {
          ...
          methods: {
            ...
            $_addPopup: function() {
              var t = this;
              if (
                ((this.popup = new this.mapbox.Popup(c({}, this._props))),
