...
Component.options.__file = "/home/soal/dev/HM/vue-mapbox/src/components/Layer.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-19da7404", Component.options)
  } else {
    hotAPI.reload("data-v-19da7404", Component.options)
  }
})()}
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    __WEBPACK_IMPORTED_MODULE_1__mglMessageBus__["a" /* default */].$on('mgl-load', function (map) {
      ...
      _this.$emit('layer-source-loaded', _this.sourceId);
      __WEBPACK_IMPORTED_MODULE_1__mglMessageBus__["a" /* default */].$emit('layer-source-loaded', _this.sourceId);
      ...
      _this.layer = {
        ...
        type: 'fill',
        layout: {
          visibility: _this.hidden ? 'none' : 'visible'
        },
        paint: { 'fill-color': 'rgba(' + 12 * (_this.layerId.length * 3) + ',153,80,0.55)' }
      };
      _this.map.addLayer(_this.layer, _this.before);
      _this.$emit('layer-loaded', _this.sourceId);
      __WEBPACK_IMPORTED_MODULE_1__mglMessageBus__["a" /* default */].$emit('layer-loaded', _this.sourceId);
    });
  },
  mounted: function mounted() {},
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_Layer_vue__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_Layer_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__components_Layer_vue__);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MglLayer", function() { return MglLayer; });
...
var MglLayer = __WEBPACK_IMPORTED_MODULE_6__components_Layer_vue___default.a;
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-19da7404", module.exports)
  }
}
