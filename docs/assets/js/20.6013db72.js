            ...
            return s(
              ...
              [
                ...
                s("p", [
                  ...
                  s("code", [t._v("load")]),
                  t._v(" event. Pyload of the event contains Mapbox GL JS "),
                  s("code", [t._v("Map")]),
                  t._v(" object.")
                ]),
                t._v(" "),
                ...
                s("p", [
                  t._v(
                    "Asynchronous map methods exposed at GlMap component in "
                  ),
                  s("code", [t._v("actions")]),
                ...
                s("p", [
                  ...
                  s("code", [t._v(".stop()")]),
                  t._v(
                    " just stops all animations on map, updates props with new positions and return Promise with map parameters in the moment when "
                  ),
                  s("code", [t._v(".stop()")]),
                  t._v(" called.")
                ]),
