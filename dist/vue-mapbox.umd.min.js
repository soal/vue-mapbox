  ...
  return (function(t) {
    ...
    "01f9": function(t, e, n) {
      ...
      t.exports = function(t, e, n, y, g, b, _) {
        ...
        var x,
          ...
          C = ("Array" == e && M.entries) || O;
        if (
          (C &&
            (($ = f(C.call(new t()))),
            $ !== Object.prototype &&
              $.next &&
              (u($, w, !0), r || "function" == typeof $[d] || a($, d, v))),
          E &&
            O &&
            O.name !== m &&
            ((L = !0),
          ...
          if (
            ...
            for (S in x) S in M || i(M, S, x[S]);
          else o(o.P + o.F * (l || L), e, x);
        return x;
      };
    },
    "0d58": function(t, e, n) {
    ...
    "4a59": function(t, e, n) {
      var r = n("9b43"),
        ...
        u = {},
        f = {};
      e = t.exports = function(t, e, n, d, l) {
        var p,
          h,
          m,
          v,
    ...
    ac6a: function(t, e, n) {
      for (
        ...
        var v,
          ...
          b = a[y],
          _ = b && b.prototype;
        if (_ && (_[f] || s(_, f, l), _[d] || s(_, d, y), (c[y] = l), g))
    ...
    fb15: function(t, e, n) {
            ...
            $_emitEvent: function(t) {
              var e =
                arguments.length > 1 && void 0 !== arguments[1]
                  ? arguments[1]
                  : {};
              this.$emit(t, u({ map: this.map, component: this }, e));
            },
            $_emitMapEvent: function(t) {
              var e =
                arguments.length > 1 && void 0 !== arguments[1]
                  ? arguments[1]
                  : {};
              this.$_emitEvent(t.type, u({ mapboxEvent: t }, e));
            }
          }
        },
        d = {
      ...
      function m() {
        ...
        return (
          Object.entries(p).forEach(function(e) {
            t[e[0]] = function(t, n) {
              return h.call(this, e[0], e[1].bind(this), t, n);
            };
          }),
          t
        );
      ...
      var v = { watch: m() },
        ...
        x = {
          ...
          created: function() {
            (this.map = null), (this.propsIsUpdating = {}), (this.mapbox = s.a);
          },
          mounted: function() {
            var t = this;
      ...
      var I = $(S, o, i, !1, null, "9b87638e", null);
      I.options.__file = "GlMap.vue";
      var w = I.exports,
        E = {
          methods: {
            $_emitSelfEvent: function(t) {
              this.$_emitMapEvent(t, { control: this.control });
            },
        ...
        P = function() {
          ...
          return n(
            ...
            [t.marker ? t._t("marker") : t._e(), t._t("default")],
            2
          );
        },
        B = [],
        F = { drag: "drag", dragstart: "dragstart", dragend: "dragend" },
        A = {
          name: "MapMarker",
          mixins: [f, E],
          inject: ["mapbox", "map"],
          ...
          created: function() {
            ...
            var n = Object.keys(F);
            this.$_bindSelfEvents(n, this.marker), (this.initial = !1);
          },
          beforeDestroy: function() {
            void 0 !== this.map &&
              void 0 !== this.marker &&
      ...
      var H = q.exports,
          ...
          methods: {
            $_deferredMount: function() {
              if (
                ...
                var t = u({ type: "geojson" }, this.source);
                try {
        ...
        tt = {
          ...
          methods: {
            $_deferredMount: function() {
              var t = u({ type: "image" }, this.source);
              this.map.on("dataloading", this.$_watchSourceLoading);
              try {
                this.map.addSource(this.sourceId, t);
              } catch (e) {
              ...
              this.$_addLayer(), this.$_bindLayerEvents(W), (this.initial = !1);
            },
            $_addLayer: function() {
              var t = this.map.getLayer(this.layerId);
              if (t) {
        ...
        et = {
          ...
          methods: {
            $_deferredMount: function() {
              var t = u({ type: "canvas" }, this.source);
              this.map.on("dataloading", this.$_watchSourceLoading);
              try {
                this.map.addSource(this.sourceId, t);
              } catch (e) {
        ...
        nt = {
          ...
          methods: {
            $_deferredMount: function() {
              var t = u({ type: "video" }, this.source);
              this.map.on("dataloading", this.$_watchSourceLoading);
              try {
                this.map.addSource(this.sourceId, t);
              } catch (e) {
        ...
        rt = {
          ...
          methods: {
            $_deferredMount: function() {
              var t = u({ type: "vector" }, this.source);
              this.map.on("dataloading", this.$_watchSourceLoading);
              try {
                this.map.addSource(this.sourceId, t);
              } catch (e) {
        ...
        ot = {
          ...
          methods: {
            $_deferredMount: function() {
              var t = u({ type: "raster" }, this.source);
              this.map.on("dataloading", this.$_watchSourceLoading);
              try {
                this.map.addSource(this.sourceId, t);
              } catch (e) {
      ...
      function it(t) {
        return t.baseMap ? t : void 0 !== t.$parent ? it(t.$parent) : void 0;
      }
      var at = {
          created: function() {
            this.map = null;
