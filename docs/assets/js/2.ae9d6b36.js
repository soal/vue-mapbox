      ...
      n(117)("replace", 2, function(t, e, n) {
        return [
          function(i, s) {
            ...
            var r = t(this),
              a = null == i ? void 0 : i[e];
            return void 0 !== a ? a.call(i, r, s) : n.call(String(r), i, s);
          },
          n
        ];
      });
 ...
 * @license MIT */ void 0 ===
        (s =
          ...
          typeof (i = function() {
            ...
            (n.configure = function(t) {
              ...
              (n.set = function(t) {
                var e = n.isStarted();
                (t = s(t, i.minimum, 1)), (n.status = 1 === t ? null : t);
                var u = n.render(!e),
              ...
              (n.inc = function(t) {
                ...
                return e
                  ? ("number" != typeof t &&
                      (t = (1 - e) * s(Math.random() * e, 0.1, 0.95)),
                    (e = s(e + t, 0, 0.994)),
                    n.set(e))
                  : n.start();
              }),
              ...
              (n.render = function(t) {
                ...
                return (
                  ...
                  i.showSpinner ||
                    ((s = e.querySelector(i.spinnerSelector)) && h(s)),
      ...
      if (
        ...
        l = function(t, e) {
          var n = this instanceof l,
            i = o(t),
            r = void 0 === e;
          return !n && i && t.constructor === l && r
            ? t
            : s(
                d
                  ? new c(i && !r ? t.source : t, e)
                  : c(
    ...
    function(t, e, n) {
      ...
      function d(t, e, n) {
        ...
        const i = c(e);
        return i in t
          ? Object.assign({}, t[i], { type: "page", path: h(t[i].path) })
          : (console.error(
      ...
      function v(t, e, n, i) {
        const { pages: s, themeConfig: r } = n,
          a = (i && r.locales && r.locales[i]) || r;
        if ("auto" === (t.frontmatter.sidebar || a.sidebar || r.sidebar))
          return (function(t) {
            const e = g(t.headers || []);
            return [
              {
        ...
        const o = a.sidebar || r.sidebar,
          u = s.reduce((t, e) => ((t[c(e.regularPath)] = e), t), {});
        if (o) {
      ...
      k.options.__file = "NavLink.vue";
      var C = k.exports,
        x = {
          components: { NavLink: C },
          computed: {
            data: function() {
      ...
      var j = N.exports,
        P = {
          components: { NavLink: C, DropdownTransition: j },
          data: function() {
            return { open: !1 };
          },
          props: { item: { required: !0 } },
      ...
      U.options.__file = "DropdownLink.vue";
      var A = {
          components: { NavLink: C, DropdownLink: U.exports },
          computed: {
            userNav: function() {
              return (
            ...
            nav: function() {
              ...
              if (e && Object.keys(e).length > 1) {
                ...
                return Object(T.a)(this.userNav).concat([r]);
              }
              return this.userNav;
            },
            userLinks: function() {
      ...
      function q(t, e, n) {
        ...
        e.forEach(function(t) {
          "group" === t.type
            ? i.push.apply(i, Object(T.a)(t.children || []))
            : i.push(t);
        });
      ...
      var G = {
            ...
            editLink: function() {
              if (!1 !== this.$page.frontmatter.editLink) {
                ...
                return (
                  ...
                  l && n ? this.createEditLink(e, l, s, a, p) : void 0
                );
              }
            },
          ...
          methods: {
            createEditLink: function(t, e, n, i, s) {
      ...
      var Y = {
          ...
          render: function(t, e) {
            var n = e.parent,
              ...
              h = null == p ? 1 : p,
              d = !!s.themeConfig.displayAllHeaders;
            return "auto" === o.type
              ? [c, X(t, o.children, o.basePath, r, h)]
              : (l || d) && o.headers && !a.test(o.path)
                ? [c, X(t, g(o.headers), o.path, r, h)]
                : c;
          }
        },
      ...
      var tt = {
          components: { SidebarGroup: Z.exports, SidebarLink: K, NavLinks: M },
          props: ["items"],
          data: function() {
          ...
          methods: {
            ...
            isActive: function(t) {
              return f(this.$route, t.regularPath);
            }
          }
        },
        et = (n(135),
      ...
      var nt = {
          ...
          mounted: function() {
            var t = this;
            r.a.configure({ showSpinner: !1 }),
              this.$router.beforeEach(function(t, e, n) {
                t.path === e.path || i.a.component(t.name) || r.a.start(), n();
              }),
              this.$router.afterEach(function() {
                r.a.done(), (t.isSidebarOpen = !1);
              });
          },
          methods: {
