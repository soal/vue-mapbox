            ...
            while ((c = g.exec(n))) {
              if (
                ...
                l > v &&
                  ...
                  c[s] > 1 && c.index < n[s] && a.apply(h, c.slice(1)),
                  (d = c[0][s]),
                  (v = l),
                  h[s] >= y))
              )
      ...
      t.exports = function(t) {
        return function(e) {
          var n,
            ...
            u = 0,
            f = [];
          while (s > u) i.call(a, (n = c[u++])) && f.push(t ? [n, a[n]] : a[n]);
          return f;
        };
      };
    },
    ...
    ac6a: function(t, e, n) {
      for (
        ...
        var v,
          ...
          b = a[y],
          _ = b && b.prototype;
        if (_ && (_[f] || c(_, f, d), _[l] || c(_, l, y), (s[y] = d), g))
    ...
    fb15: function(t, e, n) {
            ...
            $_emitEvent: function(t) {
              var e =
                arguments.length > 1 && void 0 !== arguments[1]
                  ? arguments[1]
                  : {};
              this.$emit(t, c({ map: this.map, component: this }, e));
            },
            $_emitMapEvent: function(t) {
              var e =
                arguments.length > 1 && void 0 !== arguments[1]
                  ? arguments[1]
                  : {};
              this.$_emitEvent(t.type, c({ mapboxEvent: t }, e));
            }
          }
        },
        u = {
      ...
      var h = { watch: p() },
        ...
        b = {
          ...
          data: function() {
            return { initial: !0, baseMap: !0, initialized: !1 };
          },
          computed: {
            loaded: function() {
      ...
      var S = x(_, o, i, !1, null, "54c577ae", null);
      ...
      var $ = S.exports,
        ...
        T = [],
        C = { drag: "drag", dragstart: "dragstart", dragend: "dragend" },
        B = {
          name: "MapMarker",
          mixins: [s, I],
          inject: ["mapbox", "map"],
        ...
        z = B,
        F = x(z, P, T, !1, null, null, null);
      F.options.__file = "Marker.vue";
      var A = F.exports,
        R = function() {
          var t = this,
            e = t.$createElement,
        ...
        U = D,
        G = x(U, R, N, !1, null, null, null);
      G.options.__file = "Popup.vue";
      var V = G.exports,
        q = (n("a481"),
        [
          "mousedown",
      ...
      function H(t) {
        return t.baseMap ? t : void 0 !== t.$parent ? H(t.$parent) : void 0;
      }
      var W = {
          created: function() {
            this.map = null;
          ...
          methods: {
            $_deferredMount: function(t) {
              if (
                ...
                var e = c({ type: "geojson" }, this.source);
                try {
        ...
        tt = {
          ...
          methods: {
            $_deferredMount: function(t) {
              var e = c({ type: "image" }, this.source);
              (this.map = t.map),
                this.map.on("dataloading", this.$_watchSourceLoading);
              try {
                this.map.addSource(this.sourceId, e);
        ...
        nt = {
          ...
          methods: {
            $_deferredMount: function(t) {
              var e = c({ type: "video" }, this.source);
              (this.map = t.map),
                this.map.on("dataloading", this.$_watchSourceLoading);
              try {
                this.map.addSource(this.sourceId, e);
          ...
          methods: {
            $_deferredMount: function(t) {
              if (t.mapId === this.mapId) {
                this.map = t.map;
                var e = c({ type: "vector" }, this.source);
                this.map.on("dataloading", this.$_watchSourceLoading);
                try {
                  this.map.addSource(this.sourceId, e);
                } catch (n) {
        ...
        ot = {
          ...
          methods: {
            $_deferredMount: function(t) {
              this.map = t.map;
              var e = c({ type: "raster" }, this.source);
              this.map.on("dataloading", this.$_watchSourceLoading);
              try {
                this.map.addSource(this.sourceId, e);
              } catch (n) {
