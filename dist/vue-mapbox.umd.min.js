      ...
      t.exports = function(t, e, n, y, g, b, _) {
        ...
        if (
          (P &&
            ...
            $ !== Object.prototype &&
              $.next &&
              (u($, I, !0), r || "function" == typeof $[l] || a($, l, v))),
          E &&
            j &&
            j.name !== m &&
            ((L = !0),
          ...
          if (
            ((x = { values: E ? M : w(m), keys: b ? M : w(h), entries: k }), _)
          )
        ...
        function t() {
          ...
          try {
            ...
            for (var f = 0; f < u.length; f++) {
              ...
              if (a === c && u[f].innerHTML && u[f].innerHTML.trim() === n)
                return u[f];
            }
            return null;
          }
    ...
    fb15: function(t, e, n) {
      ...
      var v = { watch: m() },
        ...
        x = {
          name: "GlMap",
          mixins: [v, _, y, f],
          props: u({ mapboxGl: { type: Object, default: null } }, d),
          provide: function() {
            var t = this;
            return {
              get mapbox() {
      ...
      var w = $(S, a, s, !1, null, null, null),
        ...
        M = {
          ...
          created: function() {
            ...
            (this.control = new t(this.$props)),
              this.$_addControl(),
              this.$_bindSelfEvents(Object.keys(j), this.control);
          },
          methods: {
            trigger: function() {
        ...
        et = {
          ...
          methods: {
            $_deferredMount: function() {
              ...
              this.$_addLayer(), this.$_bindLayerEvents(X), (this.initial = !1);
            },
            $_addLayer: function() {
              var t = this.map.getLayer(this.layerId);
              if (t) {
        ...
        ct = L,
        ut = Q,
        ft = { withEvents: f, withSelfEvents: E, asControl: L, asLayer: Q },
        lt = I,
        dt = O,
        pt = M,
        ht = k,
